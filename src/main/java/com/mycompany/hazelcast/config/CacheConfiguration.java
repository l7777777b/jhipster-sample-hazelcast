package com.mycompany.hazelcast.config;
...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("jhipsterSampleHazelcast");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("jhipsterSampleHazelcast");
        ...
        config.getMapConfigs().put("com.mycompany.hazelcast.domain.*", initializeDomainMapConfig(jHipsterProperties));
